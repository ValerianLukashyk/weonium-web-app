...
const Footer = (props) => {
    ...
    useEffect(()=>{
        console.log(footerRef.current.offsetWidth, footerRef.current.offsetHeight)
    ...
    return (
        ...
        >
            ...
            >
                <Flex ref={footerRef} position="relative" align={["start", "center", "center"]} mr={5} justify='space-between' w="full" px={[0, 5, 16]} flexDir={['column', 'row', 'row']}>
                    <Box>
                        <MotionTitle text={'Valerian Lukashyk'} pad={8} />
                    </Box>

                    <Box display="flex" mr={[0, 6, 6]} style={{ alignItems: 'center', gap: 50, boxSizing: 'border-box' }}>
                        <HireButtons />
                        <CoffeeBuy />
                    </Box>
