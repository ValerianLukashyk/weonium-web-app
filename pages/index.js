        ...
        <Layout>
            <Container maxW="2xl">
                ...
                <Section delay={0.1}>
                    ...
                    <Paragraph>
                        I am a freelance and a full-stack developer based in
                        Ukraine (L&apos;viv) with a passion for building
                        interactive websites. I&apos;m using Three.js library
                        and GL Shader Language for adding interactivity to 3D
                        objects. In addition I am expert in Js-frameworks like
                        React.js(Next.js) and Vue.js. More than 1 year I&apos;m
                        learning to write back-end with Node.js. When I&apos;m
                        not writing code I spend time in my audio recording
                        studio.
                    </Paragraph>
                ...
                <Section delay={0.2}>
                    ...
                    <BioSection>
                        ...
                        Completed Kyiv International Univercity, Information
                        Science cafedra.
                    </BioSection>
                    <BioSection>
                ...
                <Section delay={0.3}>
                    ...
                    <Paragraph>Coding, Music, Art, Traveling</Paragraph>
                </Section>
                <Section delay={0.3}>
                    <Heading as="h3" variant="section-title">
                        On the web
                    ...
                    >
                        <ListItem m={1}>
                            <WebLink
                                ...
                                color="blue"
                                icon={
                                    <Icon w={12} h={12} as={IoLogoFacebook} />
                                }
                            />
                        </ListItem>
                        <ListItem m={1}>
                            <WebLink
                                ...
                                color="linkedin"
                                icon={
                                    <Icon w={12} h={12} as={IoLogoLinkedin} />
                                }
                            />
                        </ListItem>
                        <ListItem m={1}>
